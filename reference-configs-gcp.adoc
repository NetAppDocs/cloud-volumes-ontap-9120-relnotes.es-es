...
| Capacidad máxima del sistema (discos + almacenamiento de objetos) esta 1 | 500GB | 2 TB HACIA ARRIBA 2 | 10TB | 368TB | 368 TB por licencia | 2 PIB 
...
. Para obtener información sobre el soporte de región de Google Cloud Platform, consulte https://cloud.netapp.com/cloud-volumes-global-regions["Regiones globales de Cloud Volumes"^].
